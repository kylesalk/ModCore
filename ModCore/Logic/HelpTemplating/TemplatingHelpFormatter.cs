...
{
    public class TemplatingHelpFormatter : BaseHelpFormatter
    {
        private DiscordEmbedBuilder EmbedBuilder { get; }
        private Command Command { get; set; }
        private Templater Templater { get; }
        ...
        /// <param name="templater">Template token replace service.</param>
        public TemplatingHelpFormatter(CommandContext ctx, Templater templater)
            : base(ctx)
        {
        ...
        private string L(string text) => this.Templater.Transform(text);
